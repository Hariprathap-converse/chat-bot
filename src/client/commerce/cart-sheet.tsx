...
export function CartSheet() {
  ...
  return (
    <Sheet open={isCartSheetOpen} onOpenChange={setCartSheetOpen}>
      <SheetContent className="w-full sm:max-w-md flex flex-col p-0 z-[70] ">
        {/* Header */}
        <SheetHeader className="p-4 border-b flex flex-row items-center justify-between space-y-0">
          ...
          <SheetClose className="text-gray-500  hover:text-gray-400 cursor-pointer transition">
        ...
        {cart.length > 0 && (
          <div className="p-4 border-t bg-muted/5 space-y-4 shadow-[0_-5px_10px_rgba(0,0,0,0.03)] pb-4">
            ...
            <Button
              ...
              className="w-full rounded-full h-11 text-base font-semibold shadow-lg shadow-primary/20"
              size="lg"
            >
              Proceed to Checkout
            </Button>
