        ...
        {items.map((item, index) => {
              ...
              <Collapsible key={item.title} defaultOpen={item.isActive}>
                <CollapsibleTrigger asChild>
                  <div
                    ...
                    className={` flex items-center   p-1 rounded  truncate cursor-pointer group ${true ? 'opacity-0 animate-slideFadeIn transition-all ease-in-out' : ''}  ${isActive
                  ...
                  >
                    ...
                    <OverflowSpan
                      ...
                      className={`!mt-0 mb-[1px] ${hasChildren
          ...
          return (
            <li
              ...
              className={`flex items-center truncate gap-2 p-1 rounded ${true ? 'opacity-0 animate-slideFadeIn  transition-all ease-in-out' : ''} cursor-pointer group ${isActive
            ...
            >
              ...
              <OverflowSpan
                ...
                isSheetOpen={isSheetOpen}
                navSettings={navSettings}
                className={`!mt-0 mb-[1px] ${!hasChildren && level === 0
                  ? 'hover:text-primary hover:font-medium'
                  : 'hover:pl-2 group-hover:pl-2 group-hover:font-medium transition-all duration-700'
                  } ${isActive ? 'font-semibold' : ''}
        ...
        return (
          <SidebarMenuItem key={`${item.title}-${level}`} className="w-full">
            <SidebarMenuButton
              ...
              className={`flex gap-[8px] items-center min-w-full  cursor-pointer  group ${isActive
                ? ' text-primary font-semibold hover:bg-transparent '
                : 'hover:text-primary  hover:font-medium hover:bg-transparent'
                }`}
              onClick={() => {
        ...
        >
          <SidebarMenuItem>
            <CollapsibleTrigger asChild>
              <SidebarMenuButton
                tooltip={navSettings.tooltip ? item.title : ''}
                className={`flex gap-[8px] items-center min-w-full  cursor-pointer ${isActive
                  ? ' text-primary font-semibold hover:bg-transparent '
                  : 'hover:text-primary  hover:font-medium hover:bg-transparent'
                  }`}
                onClick={() => {
          ...
          <SidebarMenuItem>
            <CollapsibleTrigger asChild>
              <SidebarMenuButton
                ...
                tooltip={navSettings.tooltip ? item.title : ''}
                className={`group/item flex relative gap-[8px] items-center min-w-full hover:text-primary  cursor-pointer  ${level > 0 ? 'opacity-0 animate-slideFadeIn transition-all ease-in-out ' : ''} group ${isActive
