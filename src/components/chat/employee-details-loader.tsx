...
export default function EmployeeDetailsLoader({
  ...
  const resultMessage =
    message?.toolData?.message || "Details have been successfully recorded.";
                ...
                <div className="relative shrink-0 transition-all duration-300">
                  ...
                  <div
                    className={cn(
                      ...
                      isError
                        ? "bg-red-200"
                        : "bg-linear-to-br from-[#7468FC] to-[#918FFF]",
                    )}
                  />
                </div>
                <h1
            ...
            >
              ...
              >
                ...
                >
                  <NavChatBot
                    className={cn(
                      "w-12 h-12 opacity-20 mb-2",
                      isError && "text-red-500 opacity-40",
                    )}
                  />
                  <p
                    className={cn(
