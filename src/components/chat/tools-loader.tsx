      ...
      <div className="relative w-full max-w-[400px] overflow-hidden rounded-2xl bg-white shadow-2xl p-0 ring-1 ring-white/40">
        ...
        <div className="bg-gradient-to-r from-violet-600 to-indigo-600 px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex gap-1.5">
            <div
              className="w-2 h-2 rounded-full bg-white/40 animate-[pulse_1.5s_infinite]"
          ...
          {internalStage === "scan" && (
            <div className="flex flex-col items-center animate-scale-in w-full">
              ...
              {/* <div className="w-48 h-1.5 bg-slate-200 rounded-full overflow-hidden">
                                <div className="h-full bg-indigo-400 w-full animate-[slideRight_1s_infinite_ease-in-out]" />
                            </div> */}
              <div className="w-48 h-1.5 bg-slate-200 rounded-full overflow-hidden">
                <div className="h-full bg-indigo-400 animate-progress-bar" />
              </div>
            </div>
          )}
            ...
            >
              ...
              <div className="flex items-center gap-3 mb-4 border-b border-slate-100 pb-3">
                ...
                <div className="flex-1 min-w-0">
                  <div className="text-[10px] text-slate-400 font-bold tracking-wider mb-0.5">
                    RECIPIENT
                  </div>
