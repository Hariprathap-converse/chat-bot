...
export const sampleTableData: TableConfig = {
  title: "Employee Performance Dashboard",
  description:
    "Displays employee performance, compensation, and engagement metrics across departments for monitoring workforce productivity and growth.",
  tableName: "employee_performance",
  tableDescription:
    "Contains employee profile, role, salary, performance score, and project contribution details used for analytics dashboards.",
  ...
  columns: [
    {
      ...
      header: "Employee",
      description:
        "Employee name and profile identity used for display with avatar.",
      width: 200,
      cellType: "avatar",
    },
    {
    ...
    },
    {
      ...
      header: "Performance",
      description:
        "Performance score representing employee evaluation metrics.",
      width: 150,
      type: "number",
    ...
    },
    {
      ...
      header: "Status",
      description:
        "Current employment status such as Active, On Leave, or Resigned.",
      width: 120,
      cellType: "status",
    },
    {
      ...
      header: "Growth",
      description:
        "Indicates employee growth trend based on recent performance cycles.",
      width: 110,
      cellType: "badge",
    },
    {
